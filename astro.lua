...
local config = {
    ...
    default_theme = {
        ...
        function(hl) -- or a function that returns a new table of colors to set
    ...
    mappings = {
        ...
        n = {
            ...
            ["<leader>uA"] = { "<cmd>AerialToggle<cr>", desc = "Aerial preview" },
            ["<leader>M"] = { "<cmd>Mason<cr>", desc = "Mason manager" },
            -- quick save
